...
setwd("/media/anna/Volume/Ophiostoma/pop_genomics/2019_01_snipre")
...
data <- read.table("data_8432_genes.txt", header = TRUE)  # sample data set
...
BSnIPRE.run(data, burnin = 10000, thin = 4, iter = 50000)
...
write.table(bres, file = "data_8432_genes_bayesian_results_50k.csv", sep  = ",", row.names = FALSE)
